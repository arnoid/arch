package org.arnoid.archapplication.ui.step3;
...
public class ActivityStep3 extends AppCompatActivity implements ButtonsDecorator.ButtonsDecoratorInterface {
    ...
    public static Intent intent(Context ctx) {
        return new Intent(ctx, ActivityStep3.class);
    }
    ...
    public void findCityWeather(String city, String state) {
        ...
        i.setData(Uri.parse(networkController.citySearchUrl(city, state)));
        startActivity(i);
    }
